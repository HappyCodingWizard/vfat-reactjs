...
const getUrlParameter = function (sParam: any) {
...
const _print_inline = function (message: any) {
  if (!logger) {
    logger = document.getElementById("log");
  }
...
const lookUpPricesHistorical = async function (id: any, from: any, to: any) {
  return $.ajax({
...
const getBlockNumberFromTimestamp = async function (timestamp: any) {
...
const getSourceCode = async function (address: any) {
  return $.ajax({
...
const lookUpPricesSevenDays = async function (id: any) {
...
const get_synth_weekly_rewards = async function (synth_contract_instance: any) {
...
const isRewardPeriodOver = async function (reward_contract_instance: any) {
  const now = Date.now() / 1000;
  const periodFinish = await getPeriodFinishForReward(reward_contract_instance);
  return periodFinish < now;
};

const getPeriodFinishForReward = async function (
 ...
 */
const forHumans = function (seconds: any) {
  const levels: any = [
...
const dao_deposit = async (App: any, DAO: any, DOLLAR: any) => {
  const signer = App.provider.getSigner();
...
const rewardsContract_unstake = async function (rewardPoolAddr: any, App: any) {
  const signer = App.provider.getSigner();
...
const rewardsContract_movetoboardroom = async function (
  rewardPoolAddr: any,
  App: any
) {
  const signer = App.provider.getSigner();
...
const rewardsContract_exit = async function (rewardPoolAddr: any, App: any) {
  const signer = App.provider.getSigner();
...
const rewardsContract_claim = async function (rewardPoolAddr: any, App: any) {
  const signer = App.provider.getSigner();
...
const boardroom_claim = async function (rewardPoolAddr: any, App: any) {
  const signer = App.provider.getSigner();
...
const chefContract_stake = async function (
  chefAbi: any,
  chefAddress: any,
  poolIndex: any,
  stakeTokenAddr: any,
...
const chefContract_unstake = async function (
  chefAbi: any,
  chefAddress: any,
  poolIndex: any,
  App: any,
...
const chefContract_claim = async function (
  chefAbi: any,
  chefAddress: any,
  poolIndex: any,
  App: any,
...
const chefContract_emergencyWithdraw = async function (
  chefAbi: any,
  chefAddress: any,
  poolIndex: any,
  App: any
...
function getParameterCaseInsensitive(object: any, key: any) {
  return object[
...
function getUniPrices(tokens: any, prices: any, pool: any, chain: any = "eth") {
  var t0 = getParameterCaseInsensitive(tokens, pool.token0);
  var p0 = getParameterCaseInsensitive(prices, pool.token0)?.usd;
  var t1 = getParameterCaseInsensitive(tokens, pool.token1);
  var p1 = getParameterCaseInsensitive(prices, pool.token1)?.usd;
...
function getValuePrices(tokens: any, prices: any, pool: any) {
  var t0 = getParameterCaseInsensitive(tokens, pool.token0);
  var p0 = getParameterCaseInsensitive(prices, pool.token0)?.usd;
  var t1 = getParameterCaseInsensitive(tokens, pool.token1);
  var p1 = getParameterCaseInsensitive(prices, pool.token1)?.usd;
...
function getErc20Prices(prices: any, pool: any, chain: any = "eth") {
...
function getCurvePrices(prices: any, pool: any) {
  var price =
...
async function loadSingleChefPool(
  App: any,
  tokens: any,
  prices: any,
  chef: any,
...
async function printSynthetixPool(
  App: any,
  info: any,
  chain: any = "eth",
...
async function loadSynthetixPool(
  App: any,
  tokens: any,
  prices: any,
  abi: any,
...
async function loadBasisFork(data: any) {
...
async function getNewPricesAndTokens(
  App: any,
  tokens: any,
  prices: any,
  newAddresses: any,
...
async function getAverageBlockTime(App: any) {
