...
export async function main() {
    ...
    const pools = zeroStakingContracts.map(c => {
        return {
            address: c.stakingRewardAddress,
            abi: ZERO_STAKING_ABI,
