...
export async function getFantomPrices() {
...
export async function getFantomUniPool(App, pool, poolAddress, stakingAddress) {
  let q0, q1;
...
export async function getFantomVault(App, vault, address, stakingAddress) {
...
export async function getFantomWantVault(App, vault, address, stakingAddress) {
  const decimals = await vault.decimals();
...
export async function getFantomSpoonVault(App, spoonVault, address, stakingAddress) {
...
export async function getFantomStoredToken(App, tokenAddress, stakingAddress, type) {
  switch (type) {
...
export async function getFantomToken(App, tokenAddress, stakingAddress) {
...
export async function loadFantomSynthetixPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
...
export async function loadFantomSynthetixPool(App, tokens, prices, abi, address, rewardTokenFunction, stakeTokenFunction) {
...
export async function loadFantomBasisFork(data) {
...
export async function getFantomPoolInfo(app, chefContract, chefAddress, poolIndex, pendingRewardsFunction) {
...
export async function loadFantomChefContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
...
export async function loadMultipleFantomSynthetixPools(App, tokens, prices, pools) {
...
export async function loadMultipleFantomSynthetixPoolsSequential(App, tokens, prices, pools) {
  let totalStaked = 0, totalUserStaked = 0, individualAPRs = [];
