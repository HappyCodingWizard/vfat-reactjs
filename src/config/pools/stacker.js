...
// import {
//   STACKER_VENTURES_ABI,
// } from "../BCData";


const STACKERS = [{
  token1: "stackUSDC",
  poolAddress: "0xf5e28514bBbA556b3A89004517CcB14b9260504B",
}, {
  token1: "stackETH",
  poolAddress: "0xD278754ccAEaFE7DD17Dddd7ea51De43d26A6F51",
}, {
  token1: "stackWBTC",
  poolAddress: "0x0B878efE990e24C6F3e348305F0D0aF2d04406CB",
}]

const Pools = STACKERS.map(a => {
  return {
    address: a.poolAddress,
    // abi: STACKER_VENTURES_ABI,
    abi: "", // for test
...
async function loadSynthetixPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
  ...
  const calls = [STAKING_MULTI.endBlock(), STAKING_MULTI.emissionRate(),
  STAKING_MULTI.balanceOf(App.YOUR_ADDRESS), STAKING_MULTI.shares(App.YOUR_ADDRESS)]
  ...
  const earned = earned_['tokensAccrued'] / 10 ** rewardToken.decimals;
