...
export async function main() {
    ...
    const STARTER_CHEF_ADDR = "0x5aF74D7023A21A539e49711Bf7b81DaC48171aBE";
    const rewardTokenTicker = "STARTER";
    const STARTER_CHEF = new ethers.Contract(STARTER_CHEF_ADDR, STARTER_CHEF_ABI, App.provider);

    const startBlock = await STARTER_CHEF.startBlock();
    ...
    if (currentBlock < startBlock) {
        ...
        rewardsPerWeek = await STARTER_CHEF.polyPerBlock() / 1e18 *
            604800 / 2.0;
    }
    ...
    await loadMaticChefContract(App, tokens, prices, STARTER_CHEF, STARTER_CHEF_ADDR, STARTER_CHEF_ABI, rewardTokenTicker,
