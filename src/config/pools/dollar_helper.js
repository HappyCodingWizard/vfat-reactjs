...
export async function loadFluidStatus(App, LP, fluidEpochs, epoch) {
...
export const loadDAO = async (App, DAO, DOLLAR, uniswapAddress, liquidityPoolAddress, tokens, prices, fluidEpochs,
...
export async function loadEmptySetLP(App, LP, stakeTokenAddress, stakeTokenTicker, fluidEpochs, epoch, rewardTicker, uniPrices,
...
export const getCurrentPriceAndTimestamp = async (App, address) => {
...
export const getBasisCurrentPriceAndTimestamp = async (App, address) => {
...
export async function printDaoUnbonds(provider, DAO, epoch, fluidEpochs, epochTimeSec, price, displayDecimals) {
...
export async function printLPUnbonds(provider, LP, epoch, fluidEpochs, epochTimeSec, price, rewardTicker,
...
export async function calculateDollarAPR(DAO, parameters, twap, dollarPrice, uniPrices, totalBonded, calculateChange, epochPeriod_, epoch) {
...
export async function getTWAP(App, lpAddress, dollarAddress, baseTokenDecimals) {
...
export async function loadDollar(contractInfo, calcPrice, getEpochPeriod, getTwap) {
...
export const calculateEmptySetChange = (params, totalCoupons, totalRedeemable, price) => {
...
export const getVTDtwap = async (DAO) => {
