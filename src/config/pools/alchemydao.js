...
export async function main() {
  ...
  let p0 = await loadSynthetixPool(App, tokens, prices, Pool0.abi, Pool0.address, Pool0.rewardTokenFunction, Pool0.stakeTokenFunction);
  let p1 = await loadAlchemyPool(App, tokens, prices, Pool1.abi, Pool1.address, Pool1.rewardTokenAddress, Pool1.stakeTokenFunction);
...
async function loadAlchemyPool(App, tokens, prices, abi, address, rewardTokenAddress, stakeTokenFunction) {
  const info = await loadAlchemyPoolInfo(App, tokens, prices, abi, address, rewardTokenAddress, stakeTokenFunction);
  return await printSynthetixPool(App, info);
}

async function loadAlchemyPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
