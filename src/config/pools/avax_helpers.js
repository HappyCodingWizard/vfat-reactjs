...
export async function getAvaxPrices() {
...
export async function getAvax20(App, token, address, stakingAddress) {
...
export async function getAvaxVault(App, vault, address, stakingAddress) {
...
export async function getAvaxStoredToken(App, tokenAddress, stakingAddress, type) {
  switch (type) {
    case "uniswap":
...
export async function getAvaxToken(App, tokenAddress, stakingAddress) {
...
export async function loadAvaxSynthetixPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
...
export async function loadAvaxBasisFork(data) {
...
export async function getAvaxPoolInfo(app, chefContract, chefAddress, poolIndex, pendingRewardsFunction) {
...
export async function loadAvaxChefContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
...
export async function loadMultipleAvaxSynthetixPools(App, tokens, prices, pools) {
...
export async function loadMultipleAvaxSynthetixPoolsSequential(App, tokens, prices, pools) {
  let totalStaked = 0, totalUserStaked = 0, individualAPRs = [];
