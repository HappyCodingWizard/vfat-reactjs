...
export async function main() {
    ...
    const GOLD_CHEF_ADDR = "0xe0e400617A20ADee7B2034324C3fa4C37bce97E8";
    const rewardTokenTicker = "POLYGOLD";
    const GOLD_CHEF = new ethers.Contract(GOLD_CHEF_ADDR, GOLD_CHEF_ABI, App.provider);

    const startBlock = await GOLD_CHEF.startBlock();
    ...
    if (currentBlock < startBlock) {
        ...
        rewardsPerWeek = await GOLD_CHEF.goldPerBlock() / 1e18 *
            604800 / 2.1;
    }
    ...
    await loadMaticChefContract(App, tokens, prices, GOLD_CHEF, GOLD_CHEF_ADDR, GOLD_CHEF_ABI, rewardTokenTicker,
        "gold", null, rewardsPerWeek, "pendingEgg");
