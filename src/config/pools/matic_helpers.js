...
export async function getMaticToken(App, tokenAddress, stakingAddress) {
...
export async function loadMaticSynthetixPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
...
export async function loadMaticSynthetixPool(App, tokens, prices, abi, address, rewardTokenFunction, stakeTokenFunction) {
...
export async function loadMaticBasisFork(data) {
...
export async function getMaticPoolInfo(app, chefContract, chefAddress, poolIndex, pendingRewardsFunction) {
...
export async function loadMaticChefContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
...
export async function getMaticPrices() {
...
export async function loadMultipleMaticSynthetixPools(App, tokens, prices, pools, customURLs) {
...
export async function loadMultipleMaticSynthetixPoolsSequential(App, tokens, prices, pools) {
  let totalStaked = 0, totalUserStaked = 0, individualAPRs = [];
