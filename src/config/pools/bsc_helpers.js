...
export async function getBscUniPool(App, pool, poolAddress, stakingAddress) {
  let q0, q1;
...
export async function getValuePool(App, pool, poolAddress, stakingAddress, tokenWeights) {
  let q0, q1;
  const reserves = await pool.getReserves();
  q0 = reserves._reserve0;
  q1 = reserves._reserve1;
...
export async function getBep20(App, token, address, stakingAddress) {
...
export async function getBscVault(App, vault, address, stakingAddress) {
...
export async function getBscSwapPool(App, _3pool, address, stakingAddress, swapAddress) {
...
export async function getBscCurveToken(App, curve, address, stakingAddress, minterAddress) {
...
export async function getBscBalancerPool(App, pool, poolAddress, stakingAddress, tokens, smartToken) {
...
export async function getBscBunicornTokenPool(App, pool, poolAddress, stakingAddress, tokens, smartToken) {
...
export async function getBscBunicornStablePool(App, pool, poolAddress, stakingAddress, tokens) {
    let decimals = await pool.decimals();
    let symbol = await pool.symbol();
    let name = await pool.name();
    let totalSupply = await pool.totalSupply();
...
export async function getBscStoredToken(App, tokenAddress, stakingAddress, type) {
  switch (type) {
    case "uniswap":
...
export async function loadBscSynthetixPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
...
export async function loadBscSynthetixPool(App, tokens, prices, abi, address, rewardTokenFunction, stakeTokenFunction) {
...
export async function loadBscBasisFork(data) {
...
export async function loadMultipleBscSynthetixPools(App, tokens, prices, pools) {
