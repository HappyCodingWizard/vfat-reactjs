...
export async function printChefContractPoolsTable(title, App, chef, chefAddress, chefAbi, rewardTokenTicker,
...
export function buildChefPool(App, chefAbi, chefAddr, prices, tokens, poolInfo, poolIndex, poolPrices,
  totalAllocPoints, rewardsPerWeek, rewardTokenTicker, rewardTokenAddress,
...
export const _build_link = function (message, onclickFunction, uuid = ID()) {
...
export const _truncate_link = function (link, maxLength) {
