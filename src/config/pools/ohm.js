...
export const ohmDaoContract_stake = async function (App, ohmDaoAbi, ohmDaoAddress, ohmAddress) {
  const signer = App.provider.getSigner()
...
export const ohmDaoContract_unstake = async function (App, ohmDaoAbi, ohmDaoAddress) {
  const signer = App.provider.getSigner()
  const OHM_DAO_CONTRACT = new ethers.Contract(ohmDaoAddress, ohmDaoAbi, signer)
...
export const ohmDaoContract_claim = async function (App, ohmDaoAbi, ohmDaoAddress) {
  const signer = App.provider.getSigner()
