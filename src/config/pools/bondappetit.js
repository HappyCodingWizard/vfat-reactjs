...
const Pools = [
  "0x4E995D583D54bdc755748D11D429ABdaAdCFA0B7",
  "0x4E5E8c5294F492865CAe4E4E92cDD8C499FfdEcC",
  "0xd1f8E97f5Af0233888f60dC40c4FaD2e1aC2F259",
  "0x1c66017AAd551dDbAEE6085a8619A5063963fCB7",
...
export async function main() {
  ...
  let p = await loadBondappetitSynthetixPools(App, tokens, prices, Pools)
...
async function loadBondappetitSynthetixPools(App, tokens, prices, pools) {
...
async function loadSynthetixPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
  ...
  const weeklyRewards = currentBlock > periodFinish ? 0 : rewardRate / 1e18 * 604800 / 13.5;
