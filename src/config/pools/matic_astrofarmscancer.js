...
const CANCER_CHEF_ABI = [
  {
    inputs: [
      { internalType: 'contract CancerToken', name: '_cancer', type: 'address' },
      { internalType: 'address', name: '_devaddr', type: 'address' },
      { internalType: 'address', name: '_feeAddress', type: 'address' },
      { internalType: 'uint256', name: '_CancerPerBlock', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'user', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'CancerPerBlock', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [],
    name: 'cancer',
    outputs: [{ internalType: 'contract CancerToken', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'accCancerPerShare', type: 'uint256' },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_CancerPerBlock', type: 'uint256' }],
    name: 'updateEmissionRate',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
export async function main() {
  ...
  const CANCER_CHEF_ADDR = '0x36b861f479Ee4CbbcF8Db9d45a161b97780C3256'
  const rewardTokenTicker = 'CANCER'
  const CANCER_CHEF = new ethers.Contract(CANCER_CHEF_ADDR, CANCER_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await CANCER_CHEF.CancerPerBlock()) / 1e18) * 604800) / 2.1
