...
export async function main() {
   ...
   const PHARM_CHEF_ADDR = "0xC15176B2cb702A2C88dcd483F362d79475cdEf93";
   const rewardTokenTicker = "PHARM";
   const PHARM_CHEF = new ethers.Contract(PHARM_CHEF_ADDR, PHARM_CHEF_ABI, App.provider);

   const startBlock = await PHARM_CHEF.startBlock();
   const currentBlock = await App.provider.getBlockNumber();

   const multiplier = await PHARM_CHEF.getMultiplier(currentBlock, currentBlock + 1);
   ...
   if(currentBlock < startBlock){
    ...
    rewardsPerWeek = await PHARM_CHEF.pharmPerBlock() /1e18
    ...
    await loadPharmContract(App, tokens, prices, PHARM_CHEF, PHARM_CHEF_ADDR, PHARM_CHEF_ABI, rewardTokenTicker,
        "0x4174D07f2bA070b7f83896A00a8210b2110c077D", null, rewardsPerWeek, "pendingPharm");

    hideLoading();
  }

async function loadPharmContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
