...
export async function getHecoUniPool(App, pool, poolAddress, stakingAddress) {
  let q0, q1;
...
export async function loadHecoSynthetixPoolInfo(App, tokens, prices, stakingAbi, stakingAddress,
...
export async function loadHecoSynthetixPool(App, tokens, prices, abi, address, rewardTokenFunction, stakeTokenFunction) {
...
export async function loadHecoBasisFork(data) {
...
export async function getHecoPoolInfo(app, chefContract, chefAddress, poolIndex, pendingRewardsFunction) {
...
export async function loadHecoChefContract(App, tokens, prices, chef, chefAddress, chefAbi, rewardTokenTicker,
...
export async function getHecoPrices() {
...
export async function loadMultipleHecoSynthetixPools(App, tokens, prices, pools) {
