...
export async function main() {
    ...
    const APE_CHEF_ADDR = "0xcf14775E15167854844C0b79492265f6831CF44D";
    ...
    if (currentBlock < startBlock) {
        ...
        rewardsPerWeek = await APE_CHEF.polyapePerBlock() / 1e18 *
            604800 / 2.0;
    }
    ...
    await loadMaticChefContract(App, tokens, prices, APE_CHEF, APE_CHEF_ADDR, APE_CHEF_ABI, rewardTokenTicker,
        "polyape", null, rewardsPerWeek, "pendingPolyApe");
