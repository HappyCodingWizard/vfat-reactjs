...
const Pools = [
  "0x50a7bE05872466031611013dA54C9cc5e1166319",
  "0x34F37aA7eC34752b7E46FBFdB9D0Db802202b59E",
  "0x4d2Cd192d2ea321707bb52b266DBeaB95FB94d47"
].map(a => {
  return {
    address: a,
...
export async function main() {
  ...
  let p = await loadMultipleFuseSynthetixPools(App, tokens, prices, Pools);
...
async function loadMultipleFuseSynthetixPools(App, tokens, prices, pools) {
